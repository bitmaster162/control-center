...
R6 consumes an externally verified asymmetric authenticator assertion and independently verifies semantic, temporal, key-epoch and replay bindings around that assertion.
