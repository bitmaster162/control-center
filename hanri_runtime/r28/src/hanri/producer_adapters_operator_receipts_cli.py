...
def main() -> int:
    parser = argparse.ArgumentParser(description="HANRI R39.2.2 human decision receipt producer")
    ...
    receipt.update(summarize_skips(skipped))
    ...
    print(json.dumps({
        ...
        "human_decision_receipts_validated": receipt["human_decision_receipts_validated"],
        "human_decision_receipts_invalid": receipt["human_decision_receipts_invalid"],
        "scan_skip_count": receipt["scan_skip_count"],
        "scan_skip_reason_counts": receipt["scan_skip_reason_counts"],
        "scan_skip_source_counts": receipt["scan_skip_source_counts"],
