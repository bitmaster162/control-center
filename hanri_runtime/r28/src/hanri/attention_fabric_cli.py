...
def main() -> int:
    parser = argparse.ArgumentParser(description="HANRI R39.1 attention fabric")
    ...
    result = run_attention_fabric(payload, governor_policy=governor_policy, fabric_policy=fabric_policy)
